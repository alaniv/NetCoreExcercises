...
using System.Threading.Tasks;         // Task -> for json api

namespace WorkingWithSerialization
{
    class Program
    {
        static async Task Main(string[] args) //Modify the Main method to enable awaiting on tasks by changing void to async Task. Used for json api new
        {
            ...
            /*
                With the new API, Microsoft achieved between
